...
class ocrtests extends StatefulWidget {
  const ocrtests({Key? key}) : super(key: key);

  @override
  State<ocrtests> createState() => _ocrtestsState();
}

class _ocrtestsState extends State<ocrtests> {
  List tests = [
    //  {"name": "CBC"},
    //  {"name": "RFT"},
    ...
    return Scaffold(
      ...
      body:   Column(
        children: [
          ...
          Flexible(
            child: FutureBuilder<List<ocr>>(
                future: Apiocr.getocr(),
