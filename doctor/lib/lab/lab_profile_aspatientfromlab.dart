...
import 'lab_profile_updates/book_test/gettests_ui.dart';
import 'lab_profile_updates/screens/api_for_update/api_lab_profile.dart';
import 'lab_profile_updates/screens/api_for_update/get_lab_profile_class.dart';
import 'lab_review/api_lab_review/review.dart';
class Lab_profile_for_lab_as_patient extends StatefulWidget {
  const Lab_profile_for_lab_as_patient( {Key? key}) : super(key: key);

  @override
  State<Lab_profile_for_lab_as_patient> createState() => _Lab_profile_for_lab_as_patientState();
}

class _Lab_profile_for_lab_as_patientState extends State<Lab_profile_for_lab_as_patient> {
  late Future<labprofile> _labProfileFuture;
  String availabletests =
      'CBC 300 , RFT 300 ,HPP 500, habc 800 ';
  @override
  void initState() {
    super.initState();
    _fetchLabProfile();
...
//Icon(Icons.medical_information),
                    ...
                    FutureBuilder<Map<String, dynamic>>(
                      future: apireviews.fetchReviews(),
